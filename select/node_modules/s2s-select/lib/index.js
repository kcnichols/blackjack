...
var Select = function (_BaseComponent) {
  ...
  function Select(props) {
    ...
    _this.handleKeyDownMenu = _this.handleKeyDownMenu.bind(_this);
    _this.handleKeyDownDropDownItem = _this.handleKeyDownDropDownItem.bind(_this);
    _this.onBlurToggle = _this.onBlurToggle.bind(_this);
  ...
  _createClass(Select, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.hasOwnProperty('defaultSelectedItem')) {
        this.setState(function (prevState, props) {
          return _extends({}, prevState, { selectedItem: nextProps.defaultSelectedItem });
        });
      }
    }
  }, {
    ...
    value: function toggleSelect() {
      ...
      this.setState(_extends({}, this.state, { isOpen: !this.state.isOpen, hasError: false }));
      setTimeout(function () {
        _this2.props.cbOnClick();
      }, 0);
    }
  }, {
    key: 'selectItem',
    value: function selectItem(i) {
      ...
      setTimeout(function () {
        _this3.setState(_extends({}, _this3.state, { selectedItem: i /*isOpen: !this.state.isOpen*/ })); // NOTE: isOpen was removed because blurToggle and selectItem were both setting state and therefore not closing it.
      }, 0);
    ...
    key: 'onBlurToggle',
    value: function onBlurToggle() {
      if (this.state.isOpen) {
        this.setState(_extends({}, this.state, { isOpen: !this.state.isOpen }));
      }
    }
  }, {
    key: 'handleKeyDownMenu',
    value: function handleKeyDownMenu(e) {
      switch (e.keyCode) {
        case 32:
          // enter
          this.toggleSelect();
        ...
        case 40:
          ...
          _reactDom2.default.findDOMNode(this.refs['item0']).focus();
          this.setState(_extends({}, this.state, { isOpen: true })); //this is to combat the quickness of the onblur function causeing the component to close
    ...
    value: function handleKeyDownDropDownItem(e, index) {
      switch (e.keyCode) {
        case 9: // tab
        case 32: // enter
        case 13:
        ...
        case 40:
          // down arrow
          if (_reactDom2.default.findDOMNode(this.refs['item' + index]).nextSibling) {
            ...
            _reactDom2.default.findDOMNode(this.refs['item' + index]).nextSibling.focus();
            this.setState(_extends({}, this.state, { isOpen: true })); //this is to combat the quickness of the onblur function causeing the component to close
          }
          break;
        case 38:
          // up arrow
          if (_reactDom2.default.findDOMNode(this.refs['item' + index]).previousSibling) {
            e.preventDefault();
            _reactDom2.default.findDOMNode(this.refs['item' + index]).previousSibling.focus();
            this.setState(_extends({}, this.state, { isOpen: true })); //this is to combat the quickness of the onblur function causeing the component to close
          }
          break;
      }
    ...
    key: 'setSelectStyle',
    value: function setSelectStyle() {
      var dynamicSelectStates = void 0;
      if (this.state.hover) {
        dynamicSelectStates = this.state.isOpen ? _extends({}, this.containerStyleHover, this.containerStyleFocus) : this.containerStyleHover;
      } else {
        dynamicSelectStates = this.state.isOpen ? _extends({}, this.containerStyle, this.containerStyleFocus) : this.containerStyle;
      }

      if (this.state.hasError) {
        dynamicSelectStates = _extends({}, this.containerStyle, this.containerStyleError);
      }
    ...
    value: function onItemHover(item) {
      if (!this.state.hover) {
        this.setState(_extends({}, this.state, { itemHovered: item, hover: true }));
      }
    }
  }, {
    key: 'onMouseOut',
    value: function onMouseOut() {
      if (this.state.hover) {
        this.setState(_extends({}, this.state, { 'hover': false, itemHovered: undefined }));
      }
    }
  }, {
    ...
    value: function renderSelectOptions() {
      ...
      var selectItemStyle = void 0;
      return this.props.data.map(function (item, index) {
        var divOnMouseOver = function divOnMouseOver() {
          _this4.onItemHover(item);
        };
        var divOnMouseLeave = function divOnMouseLeave() {
          _this4.onMouseOut(item);
        };
        var divOnMouseDown = function divOnMouseDown() {
          _this4.selectItem(index);
        };
        var divOnKeyDown = function divOnKeyDown(e) {
          _this4.handleKeyDownDropDownItem(e, index);
        };

        if (item === _this4.state.itemHovered) {
          selectItemStyle = _extends({}, _this4.dropDownItem, { backgroundColor: _this4.state.hover ? _this4.hoverBackgroundColor.backgroundColor : _this4.dropDownItem.backgroundColor });
        } else {
          selectItemStyle = _this4.dropDownItem;
        }
        return _react2.default.createElement(
          'div',
          {
            className: 'option-' + index,
            'data-optionLabel': _this4.props.selectName + '-' + index,
    ...
    value: function render() {
      ...
      var dropdownStyles = this.state.isOpen ? _extends({}, this.dropDown, { visibility: 'visible' }) : _extends({}, this.dropDown, {
        visibility: 'hidden' });

      var svgStyles = void 0;
      if (this.props.isDisabled) {
        svgStyles = _extends({}, this.svgStyles, {
          fill: '#ced4da'
        });
      } else {
        svgStyles = this.state.isOpen ? _extends({}, this.svgStyles, {
          fill: '#228ae6'
        }) : _extends({}, this.svgStyles);
      }
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'defaultSelectedItem' },
                this.props.data[this.state.selectedItem]
              ),
              _react2.default.createElement(
                'span',
                { style: this.svgContainerStyle },
                _react2.default.createElement(_s2sSvgIcons.CaretDownIconSVG, { svgStyle: svgStyles })
              )
            )
          )
        ),
        !this.state.hasError ? displayItems : _react2.default.createElement(
          'div',
          { className: 'errorArea', style: this.alertStyles },
          _react2.default.createElement(_s2sSvgIcons.AlertIconSVG, { svgStyle: this.alertSVGStyles }),
          _react2.default.createElement(
            'div',
            { className: 'errorText' },
