...
var DayView = function (_S2SBaseComponent) {
  _inherits(DayView, _S2SBaseComponent);
  ...
  function DayView(props) {
    ...
    _this.displayName = 'DayView';
    _this.state = {
      'selectedDate': false
    };

    _this.moment = (0, _moment2.default)();
    _this.prev = _this.prev.bind(_this);
    _this.next = _this.next.bind(_this);
    _this.cellClick = _this.cellClick.bind(_this);
    _this.daysOnKeyPress = _this.daysOnKeyPress.bind(_this);
    _this.handleTitleClick = _this.handleTitleClick.bind(_this);
    _this.currentDate = _this.props.dateVal ? _this.props.dateVal.format('MMMM YYYY') : _this.moment.format('MMMM YYYY');
  ...
  _createClass(DayView, [{
    ...
    value: function cellClick(e) {
      ...
      var newDate = this.props.dateVal ? this.props.dateVal.clone() : this.moment;
    ...
    value: function getDays() {
      var now = this.props.dateVal ? this.props.dateVal : this.moment;
      ...
      this.moment.range(start, end).by('days', function (day) {
        days.push({
          label: day.format('D'),
    ...
    key: 'next',
    value: function next() {
      var nextDate = this.props.dateVal.clone().add(1, 'months');
    ...
    key: 'prev',
    value: function prev() {
      var prevDate = this.props.dateVal.clone().subtract(1, 'months');
    ...
    key: 'daysOnKeyPress',
    value: function daysOnKeyPress(e) {
      if (e.charCode == '13') {
        this.cellClick(e);
      }
    }
    ...
    value: function render() {
      ...
      var days = this.getDays().map(function (item, i) {
        ...
        if (_class.indexOf('prev') > -1 || _class.indexOf('next') > -1) {
          style = { cellWrapper: _extends({}, _this2.lonerDays) };
        } else {
          style = undefined;
        }
