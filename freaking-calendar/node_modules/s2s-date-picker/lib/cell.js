...
var Cell = function (_S2SBaseComponent) {
  _inherits(Cell, _S2SBaseComponent);
  ...
  function Cell(props) {
    ...
    _this.displayName = 'Cell';
    _this.state = { onHover: false };

    _this.toggleHoverState = _this.toggleHoverState.bind(_this);
  ...
  _createClass(Cell, [{
    ...
    value: function toggleHoverState() {
      if (this.state.onHover) {
        this.setState(_extends({}, this.state, { onHover: false }));
      } else if (!this.state.onHover) {
        this.setState(_extends({}, this.state, { onHover: true }));
      }
    }
  }, {
    key: 'prefetchStyles',
    ...
    value: function render() {
      ...
      if (this.state.onHover == true) {
        style = _extends({}, this.cellWrapper, this.cellHoverStyle);
      } else {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          style: this.props.isSelected ? _extends({}, style, this.isSelected) : style,
          tabIndex: 0,
...
Cell.propTypes = {
  ...
  dateVal: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.number]).isRequired,
